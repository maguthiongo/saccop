...
$sql = "SELECT loans.*, members.full_name 
        ...
        $where
        ORDER BY loans.issued_date DESC";
...
<head>
    ...
    margin-left: 10px;
      ...
      background-color: darkred;
        ...
        .status-poor-repayment { background-color: #fff3cd; }
        .status-defaulted { background-color: #f8d7da; }
        .status-cleared { background-color: #d1ecf1; }
